    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/dutta/OneDrive/Desktop/new attenence/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/dutta/OneDrive/Desktop/new attenence/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/-------Check atttendance-------"')
